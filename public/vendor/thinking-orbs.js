/* thinking-orbs v0.1.1 - MIT (c) Jakub Antalik
   https://github.com/Jakubantalik/thinking-orbs
   The published package ships a React component. Only that wrapper needs React;
   the frame painters below are the package's own untouched code, lifted out so
   a plain HTML page can drive them on a canvas. */
(function () {
function F(e, n) {
...
function It(e, n) {
  ...
  window.THINKING_ORBS = { MODE_DRAWS: bt, STATE_TO_MODE: Rt, resolvePreset: It };
})();
